...
pub fn gen_key(bits: usize) -> Keys {
    let mut rng = OsRng;
    // let skey = RsaPrivateKey::from_pkcs8_der(&hex::decode("").unwrap()).unwrap();
        ...
        for name in &names{
            ...
            pool.execute(move||{
                ...
                for q in &q_slice{
                    w.i=q.i;
                    let w_hash = num_bigint::BigUint::from_bytes_be(&w.hash());
                    let pow = w_hash.modpow(
                        &num_bigint::BigUint::from_bytes_be(&q.v),
                        &n,
                    );
                    mul*=pow;
                }
                let u = num_bigint::BigUint::from_str(&u)
                    .map_err(|e| PDPError { error_code: FailCode::ParameterError(e.to_string()) }).unwrap();
                let mu = num_bigint::BigUint::from_str(&mu)
                    .map_err(|e| PDPError { error_code: FailCode::ParameterError(e.to_string()) }).unwrap();
                let u_pow_mu = u.modpow(&mu, &n);
                mul*=u_pow_mu;
...
fn redo_generate_sigma(
    ...
    let phi = num_bigint::BigUint::from_str(&phi).map_err(|_e|PDPError{ error_code: FailCode::ParameterError("There is something wrong with the format of phi!".to_string()) })?;
